//#region node_modules/.nitro/vite/services/ssr/assets/registry-dYL5WTs-.js
var KNOWN_VASPS = {
...
var LEDGER = {
	"0xSuspect_Burner_Wallet_A": [
		...
		{
			to: "0xLayering_Wallet_C",
			amount: 2500,
			token: "USDT",
			txid: "0xef5633b0",
			timestamp: "2026-09-08T12:14:00+05:30",
			chain: "ethereum"
		},
		{
			to: "0xBridgeRouter_FixedFloat",
			amount: 1e4,
			token: "USDT",
			txid: "0xcc91f001",
			timestamp: "2026-09-08T12:18:00+05:30",
			chain: "ethereum"
		}
	],
	"0xLayering_Wallet_B": [{
		to: "0xLayering_Wallet_D",
		amount: 4900,
		token: "USDT",
		txid: "0xij9012kl",
		timestamp: "2026-09-08T13:02:00+05:30",
		chain: "ethereum"
	}, {
		to: "0xTornadoCashMixerRouter",
		amount: 4900,
		token: "USDT",
		txid: "0xmn3456op",
		timestamp: "2026-09-08T13:05:00+05:30",
		chain: "ethereum"
	}],
	"0xLayering_Wallet_C": [{
		to: "0xSuspect_Intermediary_X1",
		amount: 2450,
		token: "USDT",
		txid: "0xqa88c201",
		timestamp: "2026-09-08T13:20:00+05:30",
		chain: "ethereum"
	}],
	"0xLayering_Wallet_D": [{
		to: "0xWazirXInboundClusterA2",
		amount: 4800,
		token: "USDT",
		txid: "0xqr7890st",
		timestamp: "2026-09-08T14:11:00+05:30",
		chain: "ethereum"
	}],
	"0xSuspect_Intermediary_X1": [{
		to: "0xCoinDCXReceivingWallet",
		amount: 1250,
		token: "USDT",
		txid: "0xdcx11aa",
		timestamp: "2026-09-08T14:40:00+05:30",
		chain: "ethereum"
	}, {
		to: "0xBinanceDepositHotWalletX901",
		amount: 1200,
		token: "USDT",
		txid: "0xbnx22bb",
		timestamp: "2026-09-08T14:41:00+05:30",
		chain: "ethereum"
	}],
	"0xScam_Collection_TRON": [{
		to: "0xBridgeRouter_FixedFloat",
		...
		token: "USDT",
		txid: "TRON_TX_7701",
		timestamp: "2026-09-07T03:12:00+05:30",
		chain: "tron"
	}],
	"0xLayering_Wallet_X": [{
		to: "0xCoinDCXReceivingWallet",
		...
		token: "USDT",
		txid: "0xlayx09",
		timestamp: "2026-09-07T18:00:00+05:30",
		chain: "ethereum"
	}],
	"0xOffshore_Mixer_Node": [{
		to: "0xTornadoCashMixerRouter",
		...
		token: "USDT",
		txid: "0xoffmix1",
		timestamp: "2026-09-07T19:12:00+05:30",
		chain: "ethereum"
	}]
};
var CO_SPEND = [{
...
/** Live mixer / privacy-pool contracts (lowercase hex for matching). */
var MIXER_CONTRACTS = {
	"0xTornadoCashMixerRouter": "Tornado Cash (labelled)",
	"0xOffshore_Mixer_Node": "Offshore mixer node",
	...
	"0xfd8610d20aa16395a1e5874cb6c81b21ea3d5a24": "Aztec Connect",
...
var DEFI_ROUTERS = {
	...
	"0x4d73adb72bc3dd368966edd0f0b2148404a82b9d": "LayerZero Endpoint"
};
//#endregion
export { DEFI_ROUTERS as a, KNOWN_VASPS as c, SANCTIONS as d, TYPOLOGY_LABEL as f, CO_SPEND as i, LEDGER as l, BRIDGE_EVENTS as n, DIRECTORY as o, COMPLAINTS as r, ENTITY_LABELS as s, BRIDGES as t, MIXER_CONTRACTS as u };
