...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-B30D9Eik.mjs");
...
var manifest = {
	"062ba59eb4d54b021590c220bb1fec5bb960f1950a8405582fd1e763ae1fed4e": {
		functionName: "fetchLiveHops_createServerFn_handler",
		importer: () => import("./live-B-bu6FFZ.mjs")
	},
	"70db7409b4db2ee69f5d5610f299382fdf8da5ca6969092c22ddc06e5976e51f": {
		functionName: "indexStats_createServerFn_handler",
		importer: () => import("./live-B-bu6FFZ.mjs")
	},
	"84e3f85554505acf2d40e7ebe00a3fff5526fd2fa92e9265ba92a5781d12aef4": {
		functionName: "generateOfficerBrief_createServerFn_handler",
		importer: () => import("./ai-brief-BwmW3-jU.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-DGygSGFZ.mjs").then((n) => n.t),
