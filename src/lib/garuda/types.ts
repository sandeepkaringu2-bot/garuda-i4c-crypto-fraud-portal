...
export interface ClassifiedTypology {
  id: TypologyId;
  confidence: number;
  reasons: string[];
}
...
export interface SahyogDispatch {
  id: string;
  complaintId: string;
  vaspName: string;
  wallet: string;
  status: "drafted" | "queued" | "acknowledged";
  at: number;
...
export interface TraceResult {
  ...
  classified?: ClassifiedTypology;
  contractHits?: ContractHit[];
  bridges: BridgeEvent[];
  clusters: Cluster[];
